...
const RawVeganCakes = () => {
  ...
  return (
    <section className="Raw-vegan-cakes pt-12 lg:pt-24">
            ...
            <div className="flex flex-col items-center gap-3 pt-4">
              ...
              <div>
                <Link
                  target="_blank"
                  href={
                    Details[modalContent]?.navigationLink
                      ? Details[modalContent].navigationLink
                      : ""
                  }
      ...
      <style jsx>
        {`
          ${displayModal ? `body{overflow-y:hidden !important;}` : ``}
        `}
      </style>
    </section>
  );
          ...
          <div className="mt-10 sm:flex sm:flex-wrap sm:items-start md:justify-between lg:w-max">
            ...
            <div className="mt-5 w-2/3 min-w-[220px] sm:max-w-[300px] md:flex-1 md:mt-0 ">
              ...
              <p className="text-[#666666]">
                Thank you FOR EXPLORING our Raw Vegan and Gluten-free Birthday
                cake and Celebration cake website! We hope you&apos;ll find your
