...
const PrivacyPolicy = () => {
  return (
    <div className="mx-10 md:mx-32 py-10">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to CakeMeHappyyy by Mell, 37
            Byng Road, Barnet, Hertfordshire EN5 4NW.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Facebook Fan Page</strong> is a public profile named Cake Me
            Happyyy by Mell specifically created by the Company on the Facebook
            ...
            <Link
              ...
              target="_blank"
            >
              https://www.facebook.com/cakemehappyyybymell
            </Link>
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CakeMeHappyyy by Mell, accessible
            from{" "}
            <Link
              href="www.rawvegancakes.co.uk"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.rawvegancakes.co.uk
            </Link>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: info@rawvegancakes.co.uk</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <Link
              href="https://rawvegancakes.co.uk/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://rawvegancakes.co.uk/contact
            </Link>
          </p>
        </li>
        <li>
          <p>By phone number: 07900 601365</p>
        </li>
        <li>
          <p>By mail: 37 Byng Road, Barnet, Hertfordshire EN5 4NW</p>
        </li>
      </ul>
    </div>
  );
