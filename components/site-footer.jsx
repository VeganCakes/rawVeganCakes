        ...
        <footer>
          ...
          <div className="grid text-center items-center h-full grid-cols-1 md:grid-cols-4 gap-[2rem] w-[80%]">
            ...
            <div className="footer-latest_news">
              ...
              <p>
                It has been immensely challenging and equally rewarding to
                develop a range of raw vegan, gluten-free, no added sugar, dairy
                & soy free products simply using the vibrancy of flavour and
                colour to bring you super-healthy 'guilt-free' indulgent treats.
              </p>
            </div>
          </div>
          ...
          <div className="footer_rights text-xs">
            ...
            <Link
              href="https://www.cakemehappyyy.co.uk/"
