  ...
  return (
    <div className="flex flex-col justify-between items-center rounded-md border scale-95 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:scale-[1.05] transform transition-transform duration-300">
      ...
      <div className="h-full p-4 flex flex-col items-center">
        <Link style={{ color: "#469635" }} href={`/products/${product.slug}`}>
          <h1 className="inline-flex items-center text-center text-lg font-semibold tracking-wide mb-0">
            {product.name}
          </h1>
          <h5 className="mb-4 text-sm text-gray-600 text-center">
